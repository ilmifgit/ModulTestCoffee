...
//            Thread.sleep(300);
            ...
            Thread.sleep(3000);
            driver.findElement(By.cssSelector("НАПИТКИ")).click();
            Thread.sleep(3000);
            driver.findElement(By.linkText("Кофейни")).click();
            Thread.sleep(3000);
            driver.findElement(By.linkText("СВЕЖЕВЫЖАТЫЕ СОКИ")).click();
            Thread.sleep(3000);
            //skroll down
            driver.findElement(By.cssSelector(".button.button-red.__calculator no-overlay")).click();
            Thread.sleep(2000);
            driver.findElement(By.linkText("Апельсиновый -  500 г")).click();
            Thread.sleep(2000);
            //scroll up
            driver.findElement(By.cssSelector(".calculator.header-button.js_show_calculator")).click();
            Thread.sleep(2000);
